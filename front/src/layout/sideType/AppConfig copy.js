...
export const AppConfig = (props) => {
    ...
    const [theme, setTheme] = useState('bootstrap4-light-pink');
            ...
            <div className="layout-config-content">
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button className="p-link" onClick={e => changeTheme(e, 'bootstrap4-light-pink', 'light')}>
                            <img src="assets/layout/images/themes/bootstrap4-light-blue.svg" alt="Bootstrap Light Pink"/>
                        </button>
                    </div>
                    <div className="col-3 text-center">
